...
<head>
    ...
    <title>Politeknik Negeri Batam - Dashboard</title>
        ...
        <div class="overlay-glass">
            ...
            <div class="card-container">
                <div class="card">
                    ...
                    <a href="jadwal.php" class="btn">Buka »</a>
                </div>
                <div class="card">
                    <h3>Catatan Mahasiswa</h3>
                    <p>Tulis dan lihat catatan Anda.</p>
                    <a href="catatan.php"  class="btn">Buka »</a>
                </div>
            </div>
        </div>
</main>
    ...
    <script>
      ...
      (function() {
        ...
        function render(d) {
          ...
          monthYear.textContent = d.toLocaleString(undefined, {
            month: 'long',
            year: 'numeric'
          });
